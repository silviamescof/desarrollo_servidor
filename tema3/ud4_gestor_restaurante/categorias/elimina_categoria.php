...
if(!isset($_SESSION["usuario"])){
    ...
    if($_SERVER['REQUEST_METHOD']=="POST"){
        ...
        $codcat=isset($_REQUEST["codcat"]) ? $_REQUEST["codcat"] : "";
        ...
        if($valido==true){
            ...
            try{
                ...
                $stm=$pdo->prepare("DELETE from categorias where codcat = :codcat");
                $stm->bindParam(':codcat', $codcat);
						...
						<div class="inner">
							...
							<!-- Banner -->
								<section id="formulario">
									<div class="content">
										<form action="elimina_categoria.php" method="post">
											<table>
												<tr>
													<td><label for="codcat">Seleccione categoria</label></td>
													<td><select name="codcat" id="categoria">
													<?php
														while($row = $stm->fetch()){

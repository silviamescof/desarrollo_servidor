<?php
    ...
    if (($_SERVER["REQUEST_METHOD"]=="GET") && (isset($_GET["CodRes"]))) {
        ...
        $CodRes = $_GET["CodRes"];
        $row =sql_datos_restaurante($pdo,$CodRes);
    ...
    elseif (($_SERVER["REQUEST_METHOD"]=="POST")) {
        ...
        if (!$hay_errores) {
            try {
                $sql = 'update restaurantes set Correo= :correo,  Clave= :clave, Pais= :pais, CP= :codigo_postal, Ciudad= :ciudad, Direccion= :direccion, Rol=1 where CodRes= :CodRes';
								...
								<section id="banner">
									<div class="content">
                                       ...
                                       <hr class="major">
                                        ...
                                        ?>
                                             <header class="major">
										        <h2>Modificación realizada satisfactoriamente.</h2>
									        </header>   
                                            <hr class="major">
                                        <?php        
                                                }
                                        ...
                                        ?>
                                        <form action="modifica_restaurante.php" method="post">
                                            <div class="row gtr-uniform">
                                                ...
                                                <div class="col-12">
                                                    <ul class="actions">
                                                        <input type="hidden" value="<?php echo $CodRes ?>" name="CodRes" >

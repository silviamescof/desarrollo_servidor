<?php
    ...
    if ($_SERVER["REQUEST_METHOD"]<>"GET") {
        ...
        try {
            ...
            $estado = $enviado;
            $acciones = "";
            genera_enviado_acciones($estado,$acciones,$codPed, $fecha,$codRes);
                                                ...
                                                <table class="alt">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td></td>
                                                            <td></td>
                                                            <td><a href="listar_pedidos_restaurante.php?CodRes=<?php echo $codRes ?>" class="button icon solid fa-reply">Volver</a></td>
                                                        </tr>	
                                                    </tbody>
                                                </table>
                                                <?php

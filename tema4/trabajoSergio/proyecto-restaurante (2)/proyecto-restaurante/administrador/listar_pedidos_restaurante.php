<?php
	...
	if ($_SERVER["REQUEST_METHOD"]=="POST") { // CAMBIAR ESTADO A ENVIADO PEDIDO
		$codRes = $_POST["codRes"];
		$codPed = $_POST["codPed"];
		try {
    ...
    elseif (($_SERVER["REQUEST_METHOD"]=="GET") && isset($_GET["CodRes"]))
    {
		$codRes = $_GET["CodRes"];
							...
							<!-- Banner -->
								<section id="banner">
									...
									<?php
										...
										?>
										<header>
											<h1>Pedidos restaurante: <?php echo $restaurante ?></h1>
										</header>
										<div class="row">
											<div class="col-1">
											</div>

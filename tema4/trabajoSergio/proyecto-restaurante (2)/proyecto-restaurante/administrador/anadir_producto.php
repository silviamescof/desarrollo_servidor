<?php
    ...
    if ($_SERVER["REQUEST_METHOD"]<>"POST") {
        ...
        if (!$hay_errores) {
            try {
                $sql = 'insert into productos (Nombre, Descripcion, Peso, Stock, Categoria) values (:nombre, :descripcion, :peso, :stock, :categoria)';
							...
							<!-- Banner -->
								<section id="banner">
									<div class="content">
                                        ...
                                        ?>
                                        <header class="major">
										    <h2>Error al añadir producto</h2>
									    </header>
                                        <table>
                                            <thead>
                                                <tr>
                                       ...
                                       <hr class="major">
                                        ...
                                        ?>
                                             <header class="major">
										        <h2>Producto añadido satisfactoriamente.</h2>
									        </header>   
                                            <hr class="major">
                                        <?php        
                                                }
